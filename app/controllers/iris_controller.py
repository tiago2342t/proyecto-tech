...
model_path = os.path.join(os.path.dirname(os.path.abspath(
    __file__)),  '..', 'models', 'model_randomf.pkl')
...
def generate_plot(sepal_length: float, sepal_width: float, petal_length: float, petal_width: float):
    ...
    for ax in g.axes.flatten():
        ax.scatter(sepal_length, sepal_width, color='black',
                   label="Entrada del Usuario", edgecolors='white', s=100, zorder=5)
